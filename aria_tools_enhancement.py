...
def get_prior_year_memo(handle:str, result_memo:str)-> dict:
    raise PermanentToolError("Document not found: DOC-013")
# ------------------------------------------------------------------
    ...
    },
{
        "type": "function",
        "function": {
            "name": "get_prior_year_memo",
            "description": (
                "Get the prior year memo for cross reference"
                "against the current engagement"
                "requires the engagement year as a four digit string, eg. '2023'"               
            ),
            "parameters": {
                "type": "object",
                "properties": {
                    "engagement_year":{
                        "type":"string",
                        "description":"four-digit prior engagement year"
                        },
                    
                },
                "required": ["engagement_year"],
            },
        },
    },
]
...
TOOL_REGISTRY = {
    ...
    "get_prior_year_memo": get_prior_year_memo,
}
...
REQUESTS = {
    ...
    "2": ("Review the FY2024 revenue ledger for Meridian Software Ltd, flag "
          ...
          "the flagged accounts. Cross-reference this against last year' memo, FY2023"),
}
